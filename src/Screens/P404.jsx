...
const P404 = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-r from-orange-800 to-orange-400 text-white">
      ...
      <div className="relative w-48 h-48 mt-6">
        <div className="absolute top-0 left-0 animate-bounce">
          ...
          <div className="relative">
            <div className="bg-orange-800 w-32 h-32 rounded-full"></div>
            {/* Tail */}
            <div className="absolute bg-orange-500 w-12 h-6 rounded-full rotate-45 -bottom-2 left-20"></div>
            {/* Eye */}
      ...
      <div className="absolute bottom-10 w-full text-center">
        <p className="text-sm"> FreshVoltStyle © 2024-2025 Your Website. All rights reserved.</p>
      </div>
    </div>
  );
};
